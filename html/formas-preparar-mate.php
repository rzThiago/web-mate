...
<head>
    ...
    <title>Formas de Preparar un Mate</title>
    ...
    <div class="main">
        ...
        <div class="informacion-principal">
            <div class="informacion-principal-titulo">
                <h1>Formas de preparar un Mate</h1>
            </div>
            <h2>Mate amargo</h2>
            <p>Simple, sencillo, el mate amargo es la manera más tradicional de tomar el mate</p>
            <br>
            <div class="informacion-principal-imagen">
                <img src="/imagenes/mate-amargo.png">
            </div>
            <br>
            <h2>Mate Dulce</h2>
            <p>
                Quienes no gustan del sabor amargo natural de la yerba añaden azúcar, lo que suele provocar que se 
                "lave" más rápido. También hay quienes, pese a muchas resistencias, utilizan edulcorante. 
            </p>
            <br>
            <div class="informacion-principal-imagen">
                <img src="/imagenes/mate-dulce.jpeg">
            </div>
            <br>
            <h2>Con Naranja o Limon</h2>
            <p>
                Que el mate produce acidez no es ningún secreto. Algunos materos agregan cáscaras de naranja o de limón para contrarrestar el ardor de estómago y, de paso, darle un toque diferente a la infusión. 
                Antes hay que secar las cáscaras, calentarlas a fuego directo, picarlas y después mezclar con la yerba. 
            </p>
            <br>
            <div class="informacion-principal-imagen">
                <img src="/imagenes/mate-limon.png">
            </div>
            <br>
            <h2>Con Cafe</h2>
            <p>
            ...
            <br>
            <div class="informacion-principal-imagen">
                <img src="/imagenes/mate-cafe.jpg">
            </div>
            <br>
            <h2>Mate con Aguardiente</h2>
            <p>
            ...
            <br>
            <div class="informacion-principal-imagen">
                <img src="/imagenes/aguardiente.png">
            </div>
            <br>
            <h2>Con Hierbas Serranas</h2>
            <p>
            ...
            <br>
            <div class="informacion-principal-imagen">
                <img src="/imagenes/terere.png">
            </div>
            <br>
            <h2>Mate con Leche</h2>
            <p>
            ...
            <br>
            <div class="informacion-principal-imagen">
                <img src="/imagenes/mate-leche.png">
            </div>
            <br>
            <h2>Mate con cerveza</h2>
            <p>
            ...
            <br>
            <div class="informacion-principal-imagen">
                <img src="/imagenes/mate-cerveza.png">
            </div>
            <br>
            <h2>Mate de fruta</h2>
            <p>Los adeptos del mate de frutas agrega manzana, pera o ananá.</p>
            <br>
            <div class="informacion-principal-imagen">
                <img src="/imagenes/mate-fruta.png">
            </div>
            <br>
            <h2>Mate Brasileño (chimarrao)</h2>
            <p>
            ...
            <br>
            <div class="informacion-principal-imagen">
                <img src="/imagenes/mate-brasilero.png">
            </div>
        </div>
