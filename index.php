...
<head>
	...
	<title>Mas Que Una Tradicion</title>
...
<body>
		...
		<div class="contenedores">
			<article class="contenido">
				<div class="contenido-imagen">
					<a href="/html/historia-mate.php">
						<img src="imagenes/mate1.jpg">
						<div class="overlay"></div>
					</a>
				</div>
				<div class="contenido-info">
					<div class="info-titulo">
						<a href="/html/historia-mate.php"><h2>Historia del Mate</h2></a>
					</div>
			...
			<article class="contenido">
				<div class="contenido-imagen">
					<a href="/html/tipos-mate.php">
						<img src="imagenes/mate3.png">
						<div class="overlay"></div>
					</a>
				</div>
				<div class="contenido-info">
					<div class="info-titulo">
						<a href="/html/tipos-mate.php"><h2>Tipos de Mate</h2></a>
					</div>
					<div class="info-texto">
			...
			<article class="contenido">
				<div class="contenido-imagen">
					<a href="/html/como-preparar-mate.php">
						<img src="imagenes/mate3.jpg">
						<div class="overlay"></div>
					</a>
				</div>
				<div class="contenido-info">
					<div class="info-titulo">
						<a href="/html/como-preparar-mate.php"><h2>Como Preparar un Mate</h2></a>
					</div>
					<div class="info-texto">
			...
			<article class="contenido">
				<div class="contenido-imagen">
					<a href="/html/tipos-yerba.php">
						<img src="imagenes/mate4.jpg">
						<div class="overlay"></div>
					</a>
				</div>
				<div class="contenido-info">
					<div class="info-titulo">
						<a href="/html/tipos-yerba.php"><h2>Tipos de Yerba</h2></a>
					</div>
					<div class="info-texto">
			...
			<article class="contenido">
				<div class="contenido-imagen">
					<a href="/html/curar-mate.php">
						<img src="imagenes/mate5.jpg">
						<div class="overlay"></div>
					</a>
				</div>
				<div class="contenido-info">
			...
			<article class="contenido">
				<div class="contenido-imagen">
					<a href="/html/tipos-bombillas.php">
						<img src="imagenes/mate6.png">
						<div class="overlay"></div>
					</a>
				</div>
				<div class="contenido-info">
			...
			<article class="contenido">
				<div class="contenido-imagen">
					<a href="/html/formas-preparar-mate.php">
						<img src="imagenes/mate7.jpg">
						<div class="overlay"></div>
					</a>
				</div>
				<div class="contenido-info">
					<div class="info-titulo">
						<a href="/html/formas-preparar-mate.php"><h2>Formas de Preparar un Mate</h2></a>
					</div>
					<div class="info-texto">
						<p>Te contamos las variaciones de mates, las distintas formas de tomarlo y costumbres, 
							generalmente cambia dependiendo la región a la que se refiera. Como también las maneras de consumirlo</p>
					</div>
				</div>
			</article>
			<article class="contenido">
				<div class="contenido-imagen">
					<a href="/html/caracteristicas-mate.php">
						<img src="imagenes/mate8.jpg">
						<div class="overlay"></div>
					</a>
				</div>
				<div class="contenido-info">
			...
			<article class="contenido">
				<div class="contenido-imagen">
					<a href="/html/acompañar-mate.php">
						<img src="imagenes/mate9.jpg">
						<div class="overlay"></div>
					</a>
				</div>
				<div class="contenido-info">
					<div class="info-titulo">
						<a href="/html/acompañar-mate.php"><h2>¿Con qué Acompañar el Mate?</h2></a>
					</div>
					<div class="info-texto">
						<p>Aquí seleccionamos unas cuantas recetas para que los consumidores de mate puedan disfrutar 
							un acompañamiento en forma solida, tanto salado como dulce.</p>
					</div>
				</div>
			</article>
		</div>
	...
	<button class="boton-arriba">
		<a href="#"><i class="fa-solid fa-angles-up"></i></i></a>
	</button>
